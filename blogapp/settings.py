...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-a-g^w+9xjihi7c)ve+fv_a__3xah!*0eff7ga9e*c_ll&nb$em')
...
if SUPABASE_DB_URL:
    ...
    # Use the postgresql database configuration for development
